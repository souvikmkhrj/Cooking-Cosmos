...
exports.homepage = async (req, res) => {
    ...
    try {
        ...
        res.render('index', { title: "RW-Homepage", categories, food })
    } catch (error) {
...
exports.exploreCategories = async (req, res) => {
    ...
    try {
        ...
        const categories = await Category.find({}).limit(limitNumber);
        res.render('categories', { title: "RW-Categories", categories })
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreRecipe = async (req, res) => {
    ...
    try {
        ...
        res.render('recipe', { title: "RW-Recipe", recipe })
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.exploreCategoriesById = async (req, res) => {
    ...
    try {
        ...
        res.render('categories', { title: "RW-Categories", categoryById })
    } catch (error) {
        res.status(500).send({ message: error.message || "Error Occured" });
    }
}
...
exports.searchRecipe = async (req, res) => {
    try {
        ...
        // res.json(recipe);
        res.render('search', { title: "RW-Search",recipe});
...
exports.exploreLatest = async (req, res) => {
    try {
        ...
        res.render('explore-latest', { title: "RW-Search",recipe});
...
exports.submitRecipe = async (req, res) => {
    ...
    res.render('submit-recipe', { title: "RW-Submit-Recipe",infoErrorsObj,infoSubmitObj});
...
exports.loginPage = async (req, res) => {
    res.render('login', { title: "CC-Login"})
}
...
//     .then((res)=>console.log("Running OKay"))
